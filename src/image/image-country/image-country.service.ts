...
export class ImageCountryService {
  ...
  async create(countryId: string, file: Express.Multer.File) {
    try {
      ...
      throw new BadRequestException(
        'Failed to create image country: ' + error.message
      );
    }
  }
  ...
  async findAll() {
    try {
      ...
      throw new BadRequestException(
        'Failed to retrieve image countries: ' + error.message
      );
    }
  }
  ...
  async findOne(id: number) {
    try {
      ...
      throw new BadRequestException(
        'Failed to retrieve image country: ' + error.message
      );
    }
  }
  ...
  async update(id: number, updateImageCountryDto: UpdateImageCountryDto) {
    try {
      ...
      throw new BadRequestException(
        'Failed to update image country: ' + error.message
      );
    }
  }
  ...
  async remove(id: number) {
    try {
      ...
      throw new BadRequestException(
        'Failed to delete image country: ' + error.message
      );
    }
  }
}
