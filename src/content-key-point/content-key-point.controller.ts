...
export class ContentKeyPointController {
  constructor(
    private readonly contentKeyPointService: ContentKeyPointService
  ) {}
  ...
  create(
    ...
    @Body() createContentKeyPointDto: CreateContentKeyPointDto
  ) {
    return this.contentKeyPointService.create(
      countryId,
  ...
  update(
    @Param('id') id: string,
    @Body() updateContentKeyPointDto: UpdateContentKeyPointDto
  ) {
